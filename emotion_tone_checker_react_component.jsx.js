...
export default function EmotionToneChecker() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      {/* Navbar (white + green accent) */}
      <header className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              {/* Logo (green badge + name) */}
      ...
      <main className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-sm text-gray-600 mb-6">Type a sentence below and click <span className="font-semibold">Check</span>. The sentence will appear in the checked field with a simple emotion & tone readout.</p>
